...
indices_path = 'D:\\KSEM\\ResNet\\txt_recoerd\\all_correct_intersection.txt'
img_dir = 'D:/KSEM/ResNet/sort_loss/img'  # 目标图片存储路径
new_label_path = 'D:/KSEM/ResNet/sort_loss/labels'  # 新的标签路径
