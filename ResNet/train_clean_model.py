...
# 加载自定义数据集（全部用于训练）
img_dir = r"D:\KSEM\ResNet\Trojan\43k\image"
labels_file = r"D:\KSEM\ResNet\Trojan\43k\labels\labels.pth"  # 修改为 .pth 文件
...
if __name__ == '__main__':
    ...
    model_save_path = r"D:\KSEM\ResNet\clean_model\Trojan_43k"  # 保存模型路径
