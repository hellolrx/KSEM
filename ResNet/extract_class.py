...
# 定义路径
poisoned_set_img_dir = r"D:\KSEM\ResNet\Trojan\8k_5k\poison_set\image"
poisoned_set_label_path = r"D:\KSEM\ResNet\Trojan\8k_5k\poison_set\labels\labels.pth"

output_dir = r"D:\KSEM\ResNet\Trojan\extract"
...
# 随机抽取 50%
sample_size = int(len(target_files) * 0.25)
...
print(f"Randomly selected {len(selected_files)} samples (50%) from target classes")
