...
# 指定训练数据和标签路径
poisoned_set_img_dir = r"D:\KSEM\ResNet\Trojan\38k_800\image"
poisoned_set_label_path = r"D:\KSEM\ResNet\Trojan\38k_800\labels\labels.pth"
...
# 模型保存路径
model_save_dir = r"D:\KSEM\ResNet\poision_model\Trojan_38k.pth"
