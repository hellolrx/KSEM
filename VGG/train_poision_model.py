...
# 创建毒化测试数据加载器
poisoned_set = IMG_Dataset(data_dir=r"D:\Fight-Poison-With-Poison\zmx_model\26379cifar10_1blendpoisoned\data",
                           label_path=r"D:\Fight-Poison-With-Poison\zmx_model\26379cifar10_1blendpoisoned\labels",
...
def main():
    ...
    best_accuracy = 0.0
    save_path = r'D:\KSEM\VGG\poision_model'  # 指定保存路径
    ...
    for epoch in range(num_epochs):
        ...
        if accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), os.path.join(save_path, 'cifar10_blend_seed26379_1.pth'))  # 保存最佳模型
