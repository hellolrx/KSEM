...
# def main():
#     # 加载数据集
#     img_dir = r"D:\KSEM\VGG\blend_diff_poison_rate\26379cifar10_1blendpoisoned\10k_5k\poison_set\image"
#     labels_file = r"D:\KSEM\VGG\blend_diff_poison_rate\26379cifar10_1blendpoisoned\10k_5k\poison_set\labels\labels.pth"
...
#
#     # 加载训练好的模型权重
#     model_path = r"D:\KSEM\VGG\blend_diff_poison_rate\21457cifar10_1blendpoisoned\poison_model\36k"
...
#
#     # 输出文件路径（改为 .pth 格式）
#     output_file = r"D:\KSEM\VGG\txt_recoerd\cross_blend1_36k_poison_vaild5k.pth"
...
def main():
    # 加载数据集
    img_dir = r"D:\KSEM\VGG\blend_diff_poison_rate\26379cifar10_1blendpoisoned\3k_7k\poison_set\image"
    labels_file = r"D:\KSEM\VGG\blend_diff_poison_rate\26379cifar10_1blendpoisoned\3k_7k\poison_set\labels\labels.pth"
    dataset = CIFAR10Dataset(img_dir, labels_file, transform=transform)
    ...
    # 输出文件路径（改为 .pth 格式）
    output_file = r"D:\KSEM\VGG\txt_recoerd\cross_blend1_36k_poison_vaild7k.pth"  # 修改文件名以反映“不匹配”逻辑
    os.makedirs(os.path.dirname(output_file), exist_ok=True)
