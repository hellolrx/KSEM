...
# 加载自定义数据集（全部用于训练）
img_dir = r"D:\KSEM\VGG\blend_diff_poison_rate\21457cifar10_0.5blendpoisoned\train_on_clean_set\image"  # 修改为图片文件夹
labels_file = r"D:\KSEM\VGG\blend_diff_poison_rate\21457cifar10_0.5blendpoisoned\train_on_clean_set\labels.pth"  # 修改为 .pth 文件
...
if __name__ == '__main__':
    ...
    model_save_path = r"D:\KSEM\VGG\clean_model\blend0.5_48k"  # 保存模型路径
